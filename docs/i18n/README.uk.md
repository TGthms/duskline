...
[Відкрити duskline](https://duskline.pages.dev/) · [Політика конфіденційності](../../privacy.html) · [Умови використання](../../terms.html)
...
Корінь репозиторію і є сайт. [Cloudflare Pages](https://duskline.pages.dev/) — основний хост; GitHub Pages — запасний. Обидва публікують статичні файли як є.
