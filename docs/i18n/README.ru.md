...
[Открыть duskline](https://duskline.pages.dev/) · [Политика конфиденциальности](../../privacy.html) · [Условия использования](../../terms.html)
...
Корень репозитория и есть сайт. [Cloudflare Pages](https://duskline.pages.dev/) — основной хост; GitHub Pages — запасной. Оба публикуют статические файлы как есть.
